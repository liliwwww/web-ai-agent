...
def run(playwright: Playwright) -> None:
    ...
    selctor0 = "select[name='agent_status']"
    ...
    try:
        ...
        # Define selectors
        select_selector = 'select[name="agent_status"]'
        target_text = '已驳回'
        result = select_option_and_verify(page,select_selector,target_text)
        print(f"Triggered change event on select element {result}")
